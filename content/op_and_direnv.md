...
the canonical example. Direnv picks up the variables to set up via a
.envrc file. 
...
from scratch, but then started poking around on the web. Then there’s
this [interesting comment][3] on GitHub in a repository about
connecting direnv and 1Password:
...
Next up, hand this off to Claude Code Web to turn it into a Python CLI
tool. I’d like to have more introspection and interactive selection of
keys. 
