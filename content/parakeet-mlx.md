...
> Parakeet MLX
>
> An implementation of the Parakeet models - Nvidia's ASR (Automatic
> Speech Recognition) models - for Apple Silicon using MLX.

Regarding the models, here’s info from [a June NVIDIA blog post][3]:

> NVIDIA Parakeet TDT 0.6B v2 is a 600-million-parameter automatic
> speech recognition (ASR) model designed for high-quality English
> transcription. It is currently ranked #1 on the Hugging Face ASR
...
> model highlights, leaderboard performance, and practical deployment
...
[3]: https://developer.nvidia.com/blog/nvidia-speech-ai-models-deliver-industry-leading-accuracy-and-performance/
